...
import { getUpcomingSessions, getPastSessions, updateSessionStatus, addSessionFeedback } from '../../services/database/sessionDatabase.js';
                ...
                <div key={session.id} className="list-group-item">
                  <div className="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center">
                    ...
                    <div className="d-flex gap-2 mt-2 mt-md-0">
                      {session.status === 'confirmed' && session.meetingType === 'online' && session.meetingLink && (
                        <a 
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title" id="feedbackModalLabel">Session Feedback</h5>
